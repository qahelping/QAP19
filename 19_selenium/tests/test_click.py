...
def test_js(browser_practice_automation):
    element = browser_practice_automation.find_element(By.CSS_SELECTOR, '[itemprop="headline"]')
    browser_practice_automation.execute_script("arguments[0].scrollIntoView();", element)
...
def test_select2(browser_practice_automation):
    select_element = browser_practice_automation.find_element(By.CSS_SELECTOR, '[data-testid="automation"]')
    select_element.click()

    option = browser_practice_automation.find_element(By.CSS_SELECTOR, '[data-testid="automation-default"]')
    option.click()
